...
namespace BluetoothLEExplorer.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            ICharacteristicPage_Bindings
        {
            ...
            {
                if (lineNumber == 281 && columnNumber == 34)
                {
                    isobj18TextDisabled = true;
                }
                else if (lineNumber == 284 && columnNumber == 34)
                {
                    isobj20TextDisabled = true;
                }
                else if (lineNumber == 287 && columnNumber == 34)
                {
            ...
            ICharacteristicPage_Bindings
        {
            ...
            // Static fields for each binding's enabled/disabled state
            private static bool isobj8FrameDisabled = false;
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 168 && columnNumber == 50)
                {
                    isobj8FrameDisabled = true;
                }
                ...
                else if (lineNumber == 249 && columnNumber == 27)
                {
                    isobj23IsCheckedDisabled = true;
                }
                else if (lineNumber == 249 && columnNumber == 131)
                {
                    isobj23VisibilityDisabled = true;
                }
                else if (lineNumber == 250 && columnNumber == 81)
                {
                    isobj24VisibilityDisabled = true;
                }
                else if (lineNumber == 259 && columnNumber == 81)
                {
                    isobj25VisibilityDisabled = true;
                }
                else if (lineNumber == 261 && columnNumber == 57)
                {
                    isobj26IsOnDisabled = true;
                }
                else if (lineNumber == 262 && columnNumber == 35)
                {
                ...
                else if (lineNumber == 245 && columnNumber == 22)
                {
                    isobj32TextDisabled = true;
                }
                else if (lineNumber == 231 && columnNumber == 46)
                {
                    isobj34TextDisabled = true;
                }
                else if (lineNumber == 234 && columnNumber == 62)
                {
                    this.obj35.Click -= obj35Click;
                }
                else if (lineNumber == 211 && columnNumber == 59)
                {
                    isobj40VisibilityDisabled = true;
                }
                else if (lineNumber == 216 && columnNumber == 130)
                {
                    isobj43VisibilityDisabled = true;
                }
                else if (lineNumber == 216 && columnNumber == 73)
                {
                    this.obj43.Click -= obj43Click;
                }
                else if (lineNumber == 214 && columnNumber == 36)
                {
                    isobj49TextDisabled = true;
                }
                else if (lineNumber == 209 && columnNumber == 32)
                {
                    isobj51TextDisabled = true;
                }
                else if (lineNumber == 196 && columnNumber == 22)
                {
                    isobj52TextDisabled = true;
                }
                else if (lineNumber == 198 && columnNumber == 22)
                {
                    isobj53TextDisabled = true;
                }
                else if (lineNumber == 200 && columnNumber == 22)
                {

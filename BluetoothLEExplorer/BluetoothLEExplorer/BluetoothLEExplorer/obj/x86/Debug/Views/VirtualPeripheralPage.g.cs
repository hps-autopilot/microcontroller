...
namespace BluetoothLEExplorer.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IVirtualPeripheralPage_Bindings
        {
            ...
            {
                if (lineNumber == 105 && columnNumber == 54)
                {
                    isobj14TextDisabled = true;
                }
                else if (lineNumber == 106 && columnNumber == 107)
                {
            ...
            IVirtualPeripheralPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 88 && columnNumber == 70)
                {
                    isobj8VisibilityDisabled = true;
                }
                else if (lineNumber == 92 && columnNumber == 70)
                {
                ...
                else if (lineNumber == 100 && columnNumber == 23)
                {

...
namespace BluetoothLEExplorer.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IMicrosoftServicePage_Bindings
        {
            ...
            private static bool isobj15CharacteristicDisabled = false;
            private static bool isobj16CharacteristicDisabled = false;
            ...
            {
                if (lineNumber == 147 && columnNumber == 76)
                {
                    isobj12CharacteristicDisabled = true;
                }
                else if (lineNumber == 149 && columnNumber == 76)
                {
                    isobj13CharacteristicDisabled = true;
                }
                else if (lineNumber == 150 && columnNumber == 76)
                {
                    isobj14CharacteristicDisabled = true;
                }
                else if (lineNumber == 151 && columnNumber == 76)
                {
                    isobj15CharacteristicDisabled = true;
                }
                else if (lineNumber == 152 && columnNumber == 76)
                {
                    isobj16CharacteristicDisabled = true;
                }
                else if (lineNumber == 137 && columnNumber == 24)
                {
                    isobj17TextDisabled = true;
                }
                else if (lineNumber == 138 && columnNumber == 114)
                {
                ...
                else if (lineNumber == 130 && columnNumber == 31)
                {
                    this.obj20.Click -= obj20Click;
                }
                else if (lineNumber == 131 && columnNumber == 31)
                {
            ...
            private void Update_ViewModel_IndicateCharacteristic(global::BluetoothLEExplorer.ViewModels.GenericGattCharacteristicViewModel obj, int phase)
            {
                ...
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    if (!isobj15CharacteristicDisabled)
                    {
            ...
            private void Update_ViewModel_ReadLongCharacteristic(global::BluetoothLEExplorer.ViewModels.GenericGattCharacteristicViewModel obj, int phase)
            {
                ...
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    if (!isobj16CharacteristicDisabled)
                    {
